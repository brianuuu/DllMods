...
bool Configuration::m_enableLightdashEffect = true;
bool Configuration::m_enableLightdashRings = true;
...
bool Configuration::load(const std::string& rootPath)
{
    ...
    m_enableLightdashEffect = reader.GetBoolean("Config", "bLightdashEffect", true);
    m_enableLightdashRings = reader.GetBoolean("Config", "bLightdashRings", false);
