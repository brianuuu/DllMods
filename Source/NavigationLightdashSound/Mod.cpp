...
extern "C" __declspec(dllexport) void Init(ModInfo * modInfo)
{
    ...
    if (Configuration::m_enableBumperRailSwitch)
    {
        ...
        WRITE_MEMORY(0xDFCC78, uint8_t, 0x8B, 0x83, 0x1C, 0x01, 0x00, 0x00);
        WRITE_MEMORY(0xDFCC80, uint8_t, 0xBF, 0x03, 0x00, 0x00, 0x00);
        WRITE_MEMORY(0xDFCC85, uint8_t, 0xE8, 0x76, 0xB1, 0xF9, 0xFF);
        WRITE_MEMORY(0xDFCC8A, uint8_t, 0x84, 0xC0);
        WRITE_MEMORY(0xDFCC8C, uint8_t, 0x75, 0x13);
        WRITE_MEMORY(0xDFCC8E, uint8_t, 0x8B, 0x83, 0x1C, 0x01, 0x00, 0x00);
        WRITE_MEMORY(0xDFCC94, uint8_t, 0xBF, 0x02, 0x00, 0x00, 0x00);
        WRITE_MEMORY(0xDFCC99, uint8_t, 0xEB, 0x0D, 0x90, 0x90, 0x90, 0x90);
        WRITE_MEMORY(0xDFCCA8, uint8_t, 0xE8, 0x53, 0xB1, 0xF9, 0xFF);
        WRITE_MEMORY(0xDFCCAD, uint8_t, 0x84, 0xC0);
        WRITE_MEMORY(0xDFCCAF, uint8_t, 0x90, 0x90, 0x90, 0x90, 0x74, 0x59);
    }
}
